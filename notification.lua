local lib = {}
local table1 = {}
local _SGUI = Instance.new('ScreenGui',game.Players.LocalPlayer.PlayerGui)
...
function lib.handleAlert(p56, p57, p58, p59)
	if p57.Parent == game.Players.LocalPlayer.PlayerGui.FE2Notifs[';3'] then
...
function lib.alert(text, clr, tim, special)
	task.spawn(function()
		...
		Frame.Parent = game.Players.LocalPlayer.PlayerGui.FE2Notifs[';3'];
		if _TIME > 8 then
